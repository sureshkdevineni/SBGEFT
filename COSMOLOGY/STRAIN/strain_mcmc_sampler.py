"""
MCMC sampler module for Strain MCMC Inference Pipeline
Handles MCMC chain initialization and execution
"""
...
from strain_config import CFG, HDF5_DIR
from strain_priors import log_prior, log_probability
from strain_utils import _as_int
...
def set_mcmc_files(run_id):
    """
    Set HDF5 file paths for a specific run
    """
...
def run_mcmc():
    """
    Execute MCMC sampling with burn-in and production phases
    """
    n_dim = 4
    mcfg = CFG["mcmc"]
