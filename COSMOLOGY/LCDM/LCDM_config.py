"""
Configuration module for ΛCDM MCMC analysis
"""
...
DATA_ROOT = Path(os.environ.get("LCDM_DATA", ROOT / "data"))

# Output directory
OUTPUT_FOLDER = "CMBPRIORSplusBAO" # user-editable label
HDF5_DIR = DATA_ROOT / "LCDM-MCMC-CHAINS" / OUTPUT_FOLDER
...
N_WALKERS = 28     # user editable
N_BURN    = 50     # user editable
N_STEPS   = 500    # increase steps if needed until R_hat < 1.01
...
CFG = {
    ...
    'use_des5y_sn': True, # Input True or False
...
theta_inits = {
    1: np.array([0.306, 0.0220, 0.122]),
    2: np.array([0.300, 0.0224, 0.120]),
    3: np.array([0.294, 0.0228, 0.118]),
    4: np.array([0.288, 0.0232, 0.116]),
}
